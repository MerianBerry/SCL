...
bool Packager::readIndex(scl::reduce_stream &archive) {
  scl::string content;
  archive >> content;
  xml::XmlDocument doc;
...
Packager::mPackRes Packager::writeMemberPack(scl::reduce_stream &archive,
  ...
  archive.write_uncompressed(header, SPK_HEADER_SIZE);
